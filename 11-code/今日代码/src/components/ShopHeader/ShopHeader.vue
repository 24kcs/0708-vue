<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShowBubulletin=!isShowBubulletin">
      ...
      <div class="header-content">
        ...
        <p class="shop-notice">{{info.bubulletin}}</p>
      </div>
    </div>
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="isShowBubulletin">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShowBubulletin=!isShowBubulletin">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
        <div class="brief-modal-cover" @click="isShowBubulletin=!isShowBubulletin"></div>
      </div>
    </transition>
...
export default {
  ...
  data() {
    return {
      isShowBubulletin: false, // 商家信息
      isShowSupports: false, // 活动信息
